...
def use_csv_bones_dictionary():
    bones_dictionary = (__file__ + "dictionary/bones_dictionary.csv").replace("import_csv.py", "")
...
def use_csv_bones_fingers_dictionary():
    finger_bones_dictionary = (__file__ + "dictionary/bones_fingers_dictionary.csv").replace("import_csv.py", "")
...
def use_csv_translations_dictionary():
    translations_dictionary = (__file__ + "dictionary/translations.csv").replace("import_csv.py", "")

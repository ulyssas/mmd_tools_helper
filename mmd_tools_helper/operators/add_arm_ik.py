...
def main(context):
    ...
    DOUBLE_LENGTH_OF_ELBOW_BONE = context.active_object.data.bones[ELBOW_LEFT].length * 2
    TWENTIETH_LENGTH_OF_ELBOW_BONE = context.active_object.data.bones[ELBOW_LEFT].length * 0.05
    ...
    bone = context.active_object.data.edit_bones.new("elbow_IK_L_t")
    bone.head = context.active_object.data.edit_bones["elbow_IK_L"].head
    bone.tail = context.active_object.data.edit_bones["elbow_IK_L"].head
    ...
    if hasattr(context.active_object.pose.bones["elbow_IK_L_t"], "mmd_bone"):
        ...
        context.active_object.pose.bones["elbow_IK_L_t"].mmd_bone.is_tip = True
    bpy.ops.object.mode_set(mode="EDIT")

    bone = context.active_object.data.edit_bones.new("elbow_IK_R_t")
    bone.head = context.active_object.data.edit_bones["elbow_IK_R"].head
    bone.tail = context.active_object.data.edit_bones["elbow_IK_R"].head
    bone.tail.y = bone.tail.y + TWENTIETH_LENGTH_OF_ELBOW_BONE
    bone.parent = context.active_object.data.edit_bones["elbow_IK_R"]
    bone.use_connect = False
    bpy.ops.object.mode_set(mode="POSE")
    ...
    if hasattr(context.active_object.pose.bones["elbow_IK_R_t"], "mmd_bone"):
        ...
        context.active_object.pose.bones["elbow_IK_R_t"].mmd_bone.is_tip = True
    bpy.ops.object.mode_set(mode="EDIT")

    bone = context.active_object.data.edit_bones.new("middle1_IK_L_t")
    bone.head = context.active_object.data.edit_bones["middle1_IK_L"].head
    bone.tail = context.active_object.data.edit_bones["middle1_IK_L"].head
    ...
    if hasattr(context.active_object.pose.bones["middle1_IK_L_t"], "mmd_bone"):
        ...
        context.active_object.pose.bones["middle1_IK_L_t"].mmd_bone.is_tip = True
    bpy.ops.object.mode_set(mode="EDIT")

    bone = context.active_object.data.edit_bones.new("middle1_IK_R_t")
    bone.head = context.active_object.data.edit_bones["middle1_IK_R"].head
    bone.tail = context.active_object.data.edit_bones["middle1_IK_R"].head
    bone.tail.z = bone.tail.z - TWENTIETH_LENGTH_OF_ELBOW_BONE
    ...
    if hasattr(context.active_object.pose.bones["middle1_IK_R_t"], "mmd_bone"):
        ...
        context.active_object.pose.bones["middle1_IK_R_t"].mmd_bone.is_tip = True
    bpy.ops.object.mode_set(mode="EDIT")

    bpy.ops.object.mode_set(mode="POSE")

    # Adds IK constraints
    context.object.pose.bones[ARM_LEFT].constraints.new("IK")
    context.object.pose.bones[ARM_LEFT].constraints["IK"].target = context.active_object
    context.object.pose.bones[ARM_LEFT].constraints["IK"].subtarget = "elbow_IK_L"
    context.object.pose.bones[ARM_LEFT].constraints["IK"].chain_count = 2
    context.object.pose.bones[ARM_LEFT].constraints["IK"].use_tail = True
    context.object.pose.bones[ARM_LEFT].constraints["IK"].iterations = 48
    # context.object.pose.bones[ELBOW_LEFT].constraints["IK"].use_location = False

    # context.object.pose.bones[ARM_LEFT].constraints.new("LIMIT_ROTATION")
    # context.object.pose.bones[ARM_LEFT].constraints["Limit Rotation"].use_limit_x = True
    # context.object.pose.bones[ARM_LEFT].constraints["Limit Rotation"].min_x = math.pi/360 #radians = 0.5 degrees
    # context.object.pose.bones[ARM_LEFT].constraints["Limit Rotation"].max_x = math.pi #radians = 180 degrees
    # context.object.pose.bones[ARM_LEFT].constraints["Limit Rotation"].owner_space = "POSE"
    # context.object.pose.bones[ARM_LEFT].constraints["Limit Rotation"].name = "mmd_ik_limit_override"

    context.object.pose.bones[ARM_RIGHT].constraints.new("IK")
    context.object.pose.bones[ARM_RIGHT].constraints["IK"].target = context.active_object
    context.object.pose.bones[ARM_RIGHT].constraints["IK"].subtarget = "elbow_IK_R"
    context.object.pose.bones[ARM_RIGHT].constraints["IK"].chain_count = 2
    context.object.pose.bones[ARM_RIGHT].constraints["IK"].use_tail = True
    context.object.pose.bones[ARM_RIGHT].constraints["IK"].iterations = 48
    # context.object.pose.bones[ELBOW_RIGHT].constraints["IK"].use_location = False

    # context.object.pose.bones[ARM_RIGHT].constraints.new("LIMIT_ROTATION")
    # context.object.pose.bones[ARM_RIGHT].constraints["Limit Rotation"].use_limit_x = True
    # context.object.pose.bones[ARM_RIGHT].constraints["Limit Rotation"].min_x = math.pi/360 #radians = 0.5 degrees
    # context.object.pose.bones[ARM_RIGHT].constraints["Limit Rotation"].max_x = math.pi #radians = 180 degrees
    # context.object.pose.bones[ARM_RIGHT].constraints["Limit Rotation"].owner_space = "POSE"
    # context.object.pose.bones[ARM_RIGHT].constraints["Limit Rotation"].name = "mmd_ik_limit_override"

    # context.object.pose.bones[ELBOW_LEFT].constraints.new("DAMPED_TRACK")
    # context.object.pose.bones[ELBOW_LEFT].constraints["Damped Track"].target = context.active_object
    # context.object.pose.bones[ELBOW_LEFT].constraints["Damped Track"].subtarget = ARM_LEFT
    # context.object.pose.bones[ELBOW_LEFT].constraints["Damped Track"].track_axis = 'TRACK_Y'
    # context.object.pose.bones[ELBOW_LEFT].constraints["Damped Track"].name = "mmd_ik_target_override"

    context.object.pose.bones[ELBOW_LEFT].constraints.new("IK")
    context.object.pose.bones[ELBOW_LEFT].constraints["IK"].target = context.active_object
    context.object.pose.bones[ELBOW_LEFT].constraints["IK"].subtarget = "middle1_IK_L"
    context.object.pose.bones[ELBOW_LEFT].constraints["IK"].chain_count = 1
    context.object.pose.bones[ELBOW_LEFT].constraints["IK"].use_tail = True
    context.object.pose.bones[ELBOW_LEFT].constraints["IK"].iterations = 6
    # context.object.pose.bones[WRIST_LEFT].constraints["IK"].use_location = False

    # context.object.pose.bones[ELBOW_RIGHT].constraints.new("DAMPED_TRACK")
    # context.object.pose.bones[ELBOW_RIGHT].constraints["Damped Track"].target = context.active_object
    # context.object.pose.bones[ELBOW_RIGHT].constraints["Damped Track"].subtarget = ARM_LEFT
    # context.object.pose.bones[ELBOW_RIGHT].constraints["Damped Track"].track_axis = 'TRACK_Y'
    # context.object.pose.bones[ELBOW_RIGHT].constraints["Damped Track"].name = "mmd_ik_target_override"

    context.object.pose.bones[ELBOW_RIGHT].constraints.new("IK")
    context.object.pose.bones[ELBOW_RIGHT].constraints["IK"].target = context.active_object
    context.object.pose.bones[ELBOW_RIGHT].constraints["IK"].subtarget = "middle1_IK_R"
    context.object.pose.bones[ELBOW_RIGHT].constraints["IK"].chain_count = 1
    context.object.pose.bones[ELBOW_RIGHT].constraints["IK"].use_tail = True
    context.object.pose.bones[ELBOW_RIGHT].constraints["IK"].iterations = 6
    # context.object.pose.bones[WRIST_RIGHT].constraints["IK"].use_location = False

    if hasattr(context.object.pose.bones[ARM_RIGHT], "mmd_bone"):
        context.object.pose.bones[ARM_RIGHT].mmd_bone.ik_rotation_constraint = 2  # 180*2/math.pi
        context.object.pose.bones[ARM_LEFT].mmd_bone.ik_rotation_constraint = 2  # 180*2/math.pi
